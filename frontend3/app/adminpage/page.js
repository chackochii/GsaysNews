...
<div className="flex flex-col sm:flex-row items-center gap-2 w-full">
  <input
    ...
    className="w-full sm:w-84 md:w-90 lg:w-130 border border-blue-400 dark:border-blue-600 bg-blue-50 dark:bg-gray-700 text-gray-800 dark:text-gray-100 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-blue-500"
  />
  <button
    type="button"
    onClick={handleAddCategory}
    className="w-full sm:w-auto px-3 py-2 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700"
  >
    ➕ Add
  </button>
</div>
